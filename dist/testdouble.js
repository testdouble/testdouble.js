...
// Generated by CoffeeScript 1.10.0
(function() {
  var _, hasPrototype, object, quibble, shouldReplaceWithObject, stubFor, tdFunction;
  ...
  module.exports = function(path, stub) {
    ...
    return quibble(path, stubFor(path));
  };

  stubFor = function(realThingPath) {
    var realThing;
    realThing = require(quibble.absolutify(realThingPath));
    if (shouldReplaceWithObject(realThing)) {
      return object(realThing);
    } else {
      return tdFunction((realThing != null ? realThing.name : void 0) ? realThing.name : realThingPath);
    }
  };

  shouldReplaceWithObject = function(thing) {
    return hasPrototype(thing) || _.isPlainObject(thing);
  };

  hasPrototype = function(thing) {
