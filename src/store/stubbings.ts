...
let stubbingFor = (testDouble, actualArgs) =>
  _.findLast(store.for(testDouble).stubbings, stubbing =>
    isSatisfied(stubbing, actualArgs))

let executePlan = (stubbing, actualArgs, actualContext) => {
...
let invokeCallbackFor = (stubbing, actualArgs) => {
...
let callbackArgs = (stubbing, expectedArg) => {
...
let callCallback = (stubbing, callback, args) => {
...
let createPromise = (stubbing, value, willResolve) => {
